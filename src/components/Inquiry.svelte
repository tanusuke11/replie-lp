<!-- Comment Form -->
<div class="bg-gray-50 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
	<div class="mx-auto max-w-2xl">
		<div class="text-center">
			<h2 class="text-xl text-gray-800 font-bold sm:text-3xl dark:text-white">
				アプリに関するご要望はこちらから
			</h2>
			<p class="mt-2 text-lg text-left">
				不具合、機能の改善に関するご要望など、ご意見をお寄せください。<br />
				<b>※必要なご意見についてはお時間をいただく場合がございます。</b>
			</p>
		</div>
			...
			<form>
				<div class="mb-4 sm:mb-8">
					<label
						...
						class="block mb-2 text-sm font-medium dark:text-white">年代</label
					>
					<input
						type="text"
				...
				<div>
					<label
						...
						class="block mb-2 text-sm font-medium dark:text-white">要望</label
					>
					<div class="mt-1">
						<textarea
