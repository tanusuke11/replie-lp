		...
		<label class="relative min-w-[3.5rem] text-sm text-gray-500 ml-3 dark:text-gray-400">
			...
			<span class="absolute -top-10 left-auto -right-28">
				<span class="flex items-center">
					...
					<span
						class="mt-3 inline-block whitespace-nowrap text-[11px] leading-5 font-semibold tracking-wide uppercase bg-blue-600 text-white rounded-full py-1 px-2.5"
						>Save up to 10%</span
					>
				</span>
			</span>
			...
			<table class="w-full h-px">
				...
				<thead>
					<tr>
						...
						<th
							class="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-800 text-center dark:text-white"
							scope="col">Free</th
						>
						<th
							class="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-800 text-center dark:text-white"
				...
				>
					<tr>
						<th
							class="py-3 pl-6 bg-gray-50 font-bold text-gray-800 text-left dark:bg-slate-800 dark:text-white"
							colspan="5"
