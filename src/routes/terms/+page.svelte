<section>
	<div class="container">
		...
		<br />
		<p>
			この利用規約(以下、「本規約」といいます。)は、Replie（以下、本サービスといいます。本サイトを含むものとし、以下、特に両者を区別しません。)の利用条件を定めるものです。本規約は、本サービスを利用するすべてのユーザーに適用されます。
		</p>
		<h2 id="本規約への同意">本規約への同意</h2>
		<p>
		...
		<h2 id="本サービスの提供の停止">本サービスの提供の停止</h2>
		<p>
		...
		<h2 id="保証の否認">保証の否認</h2>
		<p>
			当社は、本サービスや本サービスが提供するコンテンツに、システムバグや第三者の権利侵害が含まれないことを保証するものではありません。また、安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性を保証するものでもありません。
		</p>
		<h2 id="免責">免責</h2>
		<p>
			本サービスはコミュニケーション上のアドバイスを提供するものですが、ユーザーがアドバイスに基づいて行動を起こす際には、自己の責任と判断により行動していただく必要があります。そのため、ユーザーがアドバイスに従い、第三者とのトラブルや紛争、損害、損失、またはその他の不利益を被った場合等において、当社は一切の責任を負いません。ただし、本サービスに関する当社とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。
